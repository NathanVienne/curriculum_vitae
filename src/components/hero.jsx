...
import { mdiTrayArrowDown, mdiEmailOutline } from '@mdi/js';

function Hero() {

    const mail = "nathan.vienne@outlook.fr";
    const CV = "CV-VIENNE_Nathan.pdf"
                        ...
                        <div className="space-y-8">
                            <div className="flex space-x-5">
                                <div className="btn btn-sm md:btn-md btn-primary border-neutral hover:btn-accent hover:text-primary">
                                    ...
                                    <a href={`${import.meta.env.BASE_URL}/CV-VIENNE_Nathan.pdf`}
                                        download={`${import.meta.env.BASE_URL}/CV-VIENNE_Nathan.pdf`}>Télécharger CV</a>
                                </div>
                            ...
                            <div className="flex space-x-7">
                                <div class="Btn">
                                    <a href="https://github.com/NathanVienne" class="sign">
                                        <svg
                                            viewBox="0 0 24 24"
                                            fill="currentColor"
                                    ...
                                    <div class="legend">GitHub</div>
                                </div>
                                <div class="Btn">
                                    <a href="https://www.linkedin.com/in/nathan-vienne-7783a2215/" class="sign">
                                        <svg
                                            viewBox="0 0 24 24"
                                            fill="currentColor"
                                            className="h-6 w-6 text-white"
